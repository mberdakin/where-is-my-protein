...
1. **Overfitting:** F1 en train (resustitución) vs F1 en test; la brecha es el overfitting. El
   Random Forest usa `min_samples_leaf=10`, `max_depth=8`, `min_samples_split=10` y
   `max_leaf_nodes=16` para reducir el overfitting (que igual aparece con pocas muestras o con
   representaciones complejas como los dipéptidos).
